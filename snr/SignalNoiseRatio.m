...
real_data = zeros(1, 256);

for i = 1:256
    real_data(i) = real(rangeProfileData(1,1,i));
end
...
% 
% amp = [20514.2 15941.9 11840];
% sgn = polyval(amp,sampling_rate);

nexttile;
[r, noisePow] = snr(real_data, sampling_rate);
